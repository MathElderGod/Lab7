...
async function getRecipes() {
  ...
  /**************************/
  let currentRecipes = localStorage.getItem("recipes");
  if (currentRecipes) {
  ...
  return new Promise(async (resolve, reject) => {
    ...
    //            declared above
    for (let recipe = 0; recipe < RECIPE_URLS.length; recipe++) {
      ...
      try {
        ...
        let fetchedUrl = await fetch(RECIPE_URLS[recipe]);
        ...
        fetchedRecipes.push(fetchedUrl);
